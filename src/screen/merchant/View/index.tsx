...
const AddMerchant: React.FC = () => {
  ...
  const {privateId, locationCompanyId} = useParams<{identity: MerchantCreateType; locationCompanyId: number; action: MerchantAction; publicId: number; privateId: number}>();
