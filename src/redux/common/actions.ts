...
import {ErrorType, PreviewConfig} from '../../models';
...
export const Actions = {
  ...
  info: (message: string): ActionWithPayload<ActionType.INFO, string> =>
    createAction(ActionType.INFO, message),
  success: (message: string): ActionWithPayload<ActionType.SUCCESS, string> =>
    createAction(ActionType.SUCCESS, message),
  dismissMessage: (): Action<ActionType.DISMISS_MESSAGE> =>
    createAction(ActionType.DISMISS_MESSAGE),
  previewImages: (
    config: PreviewConfig,
  ): ActionWithPayload<ActionType.PREVIEW_IMAGES, PreviewConfig> => {
  ...
  setToken: (token: string): ActionWithPayload<ActionType.SET_TOKEN, string> =>
