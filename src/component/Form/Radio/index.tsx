  ...
  return (
    <TouchableOpacity activeOpacity={0.8} style={[styles.container, props.styles.container, props.style]} onPress={handleClick}>
      <View
        ...
        <Icon style={{marginRight: 10}} name="duihao" size={iconSize} color="#fff" />
      </View>
      <Text style={[{fontSize, lineHeight: iconSize, marginLeft: 5}, styles.label, props.styles.label]}>{props.children}</Text>
    </TouchableOpacity>
  );
};
